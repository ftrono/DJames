...
**Version 3.1.1 (2026-08-27)** - NEW color palette + dynamic colors to ClockScreen! Add NotificationsListener, SpotifyMediaObserver, PlaybackInfo + image, add lastMainActive & automatic redirect to ClockScreen, removed prior Spotify broadcast intent. Add ignore single-spike noise, add back play from custom Playlist context.
