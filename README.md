...
**Version 3.0.a10 (2025-12-28)** - Add AccountsScreen, backup & restore, notification icon, remove FFmpeg. Add DualApp debug variant. SpotifyQuery: fix legacy bug (!) and code modularization. Align to new Spotify Development Mode policy. Start rework of PlayerNodes.
