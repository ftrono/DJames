...
**Version 3.1.2 (2026-09-01)** - Add automatic redirect to ClockScreen, add ignore single-spike noise during recording, add back play from custom Playlist context. Align LibraryScreen to new UI. Centralize snapshot management for Home & Library screens. Cleaning & bugfixes.

**Version 3.1.1 (2026-08-27)** - NEW color palette + dynamic colors to ClockScreen! Add NotificationsListener, SpotifyMediaObserver, PlaybackInfo + image, lastMainActive, removed prior Spotify broadcast intent.
