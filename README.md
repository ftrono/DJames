...
**Version 3.0.a2 (v3 alpha) (2025-08-02)** - Replaced NavSuite with NavBar + NavRail, new centralized StreetUI TopBar & TopBarMenu, centralized NavUI & Drive icon, add isKeyboardOpen(). Fixed Messages leftovers deletion.
